  ...
  return (
    <div className="min-h-screen bg-[#F8FBFC] font-sans pb-20 pt-6 px-4 sm:px-6 lg:px-8 flex flex-col">
      <div className="max-w-[1600px] w-full mx-auto flex-1 flex flex-col">
        ...
        <div className="bg-white rounded-2xl shadow-md border border-[#EAF2F4] overflow-hidden relative flex mx-auto w-fit max-w-full">
          {/* Sticky Left Column for Labels */}
          <div className="w-40 md:w-56 shrink-0 border-r border-[#EAF2F4] bg-white z-10 sticky left-0 shadow-[4px_0_15px_rgba(0,0,0,0.03)]">
            {/* Header placeholder */}
          ...
          <div className="flex-1 overflow-x-auto scrollbar-hide bg-white flex">
              ...
              <div key={product._id} className="w-64 shrink-0 border-r border-[#EAF2F4] flex flex-col hover:bg-slate-50/50 transition-colors">
                ...
                <div className="h-20 p-4 flex items-center justify-center bg-white border-t border-[#EAF2F4]">
                  <button
                    ...
                    className={`w-full flex items-center justify-center gap-1.5 font-bold py-2.5 rounded-xl transition-all shadow-sm text-[13px] ${
